...
`
	...
	resolved := config.Resolved{
		BaseDir: dir, GoInput: inputDir, GoOutput: filepath.Join(dir, "bridge_generated.go"), DartOutput: filepath.Join(dir, "dart", "bridge_generated.dart"),
...
func TestGeneratedCgoDispatch(t *testing.T) {
	result, callErr := fgbDispatch(fgbMethodCall{Method: "Add", Arguments: []any{int32(4), int64(6)}}, &fgbOpaqueTransfer{})
	if callErr != nil || result != int64(10) {
		t.Fatalf("Add returned result=%#v error=%#v", result, callErr)
	}
	stats, callErr := fgbDispatch(fgbMethodCall{Method: "EchoStats", Arguments: []any{map[any]any{"count": int32(7), "ratio": 2.5}}}, &fgbOpaqueTransfer{})
	if callErr != nil {
		t.Fatal(callErr)
	}
	...
	paired, callErr := fgbDispatch(fgbMethodCall{Method: "Pair", Arguments: []any{int32(3)}}, &fgbOpaqueTransfer{})
	if callErr != nil {
		t.Fatal(callErr)
	}
	values := paired.([]any)
...
func TestIncrementDispatch(t *testing.T) {
	result, callErr := fgbDispatch(fgbMethodCall{Method: "Increment", Arguments: []any{int32(8)}}, &fgbOpaqueTransfer{})
	if callErr != nil || result != int32(9) {
