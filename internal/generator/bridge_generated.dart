...
final class Generated {
  Generated._(this._bindings, this._libraryPath)
  ...
  static Generated? _instance;

  static Generated get instance => _instance ??= Generated._open();

  static Generated open({String? libraryPath}) {
...
int fgbDecode0(Object? value, Generated bridge, String path) {
  if (value is! int) throw FormatException('$path: expected int');
  return value;
}

Object? fgbEncode0(int value, Generated bridge, String path, int depth) {
  if (depth > 64) throw FormatException('$path: value nesting exceeds 64 levels (cyclic reference?)');
  return value;
}

int fgbCstEncode0(int value, _FgbArena arena, String path, int depth) {
  if (depth > 64) throw FormatException('$path: value nesting exceeds 64 levels (cyclic reference?)');
  return value;
}

extension FgbGeneratedCalls on Generated {

int fgbInternalCall0() {
