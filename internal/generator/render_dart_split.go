...
func renderDartSplit(unit *unit, configuredOutput string) (map[string][]byte, error) {
	...
	centralRenderer.line("// ignore_for_file: unused_element, unused_import, unnecessary_import, curly_braces_in_flow_control_structures")
	...
	for _, key := range orderedKeys {
		...
		renderer.line("// ignore_for_file: unused_element, unused_import, unnecessary_import, curly_braces_in_flow_control_structures")
