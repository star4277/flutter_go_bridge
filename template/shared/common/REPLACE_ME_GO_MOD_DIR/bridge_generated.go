...
typedef struct FgbCstArgs0 FgbCstArgs0;
struct FgbCstArgs0 {
  FgbCstBytes* name;
};
typedef struct FgbCstArgs1 FgbCstArgs1;
struct FgbCstArgs1 {
  uintptr_t receiver;
  int64_t x;
  int64_t y;
...
// Required for c-shared and c-archive build modes.
func main() {}

func fgbCstDecode0(value *C.FgbCstBytes, path string) (string, error) {
	if value == nil {
		return "", fmt.Errorf("%s: null String", path)
	}
	raw, err := fgbCstReadString(unsafe.Pointer(value.ptr), value.len, path)
	if err != nil {
		return "", err
	}
	return raw, nil
...
func fgbCstDecode1(value C.uintptr_t, path string) (*api.Point, error) {
	if value == 0 {
		return nil, nil
	}
	handle := uintptr(value)
	raw, ok := fgbHandles.Load(handle)
	if !ok {
		return nil, fmt.Errorf("%s: unknown or released handle %d", path, handle)
	}
	result, ok := raw.(*api.Point)
	if !ok {
		return nil, fmt.Errorf("%s: handle %d has incompatible Go type %T", path, handle, raw)
	}
	return result, nil
}

func fgbCstDecode2(value C.int64_t, path string) (int, error) {
	raw := int64(value)
...
func fgbDcoEncode0(value string) (*C.FgbDartCObject, error) {
	return fgbDcoString(value)
}

func fgbDcoEncode1(value *api.Point) (*C.FgbDartCObject, error) {
	if value == nil {
		return fgbDcoNull()
	}
	handle := fgbNextHandle.Add(1)
	if handle == 0 || uint64(handle) > uint64(^uint64(0)>>1) {
		return nil, fmt.Errorf("opaque handle space exhausted")
	}
	fgbHandles.Store(handle, value)
	return fgbDcoInt64(int64(handle))
}

func fgbDcoEncode2(value int) (*C.FgbDartCObject, error) {
	return fgbDcoInt64(int64(value))
}
...
func fgbEncode0(value string) (any, error) {
	return value, nil
}
...
func fgbDecode1(value any, path string) (*api.Point, error) {
	...
	handle, err := fgbAsHandle(value, path)
	if err != nil {
		return nil, err
	}
	raw, ok := fgbHandles.Load(handle)
...
func fgbEncode1(value *api.Point) (any, error) {
	if value == nil {
		return nil, nil
	}
	handle := fgbNextHandle.Add(1)
...
func fgbEncode2(value int) (any, error) {
	return int64(value), nil
}

func fgbDispatch(call fgbMethodCall) (any, *fgbCallError) {
	switch call.Method {
	case "Greeting":
		...
		result := api.Greeting(arg0)
		encoded, err := fgbEncode0(result)
		if err != nil {
	...
	case "Point.Move":
		...
		arg0, err := fgbDecode2(args[1], "x")
		if err != nil {
			return nil, fgbInvalidArguments(call.Method, err)
		}
		arg1, err := fgbDecode2(args[2], "y")
		if err != nil {
			return nil, fgbInvalidArguments(call.Method, err)
		}
		receiver.Move(arg0, arg1)
		return nil, nil
	default:
		return nil, &fgbCallError{Code: "method_not_found", Message: fmt.Sprintf("unknown method %q", call.Method)}
	}
}
func fgbDispatchCst(callID int32, raw unsafe.Pointer) (*C.FgbDartCObject, *fgbCallError) {
	switch callID {
	case 0:
		if raw == nil {
			return nil, fgbInvalidArguments("Greeting", fmt.Errorf("null CST arguments"))
		}
		args := (*C.FgbCstArgs0)(raw)
		arg0, err := fgbCstDecode0(args.name, "name")
		if err != nil {
			return nil, fgbInvalidArguments("Greeting", err)
		}
		result := api.Greeting(arg0)
		encoded, err := fgbDcoEncode0(result)
		if err != nil {
			return nil, &fgbCallError{Code: "encode_error", Message: err.Error(), Details: map[any]any{"method": "Greeting"}}
		}
		return encoded, nil
	case 1:
		if raw == nil {
			return nil, fgbInvalidArguments("Point.Move", fmt.Errorf("null CST arguments"))
		}
		args := (*C.FgbCstArgs1)(raw)
		receiver, err := fgbCstDecode1(args.receiver, "receiver")
		if err != nil {
			return nil, fgbInvalidArguments("Point.Move", err)
		}
		arg0, err := fgbCstDecode2(args.x, "x")
		if err != nil {
			return nil, fgbInvalidArguments("Point.Move", err)
		}
		arg1, err := fgbCstDecode2(args.y, "y")
		if err != nil {
			return nil, fgbInvalidArguments("Point.Move", err)
		}
		receiver.Move(arg0, arg1)
		return nil, nil
	default:
		return nil, &fgbCallError{Code: "method_not_found", Message: fmt.Sprintf("unknown CST call id %d", callID)}
	}
}
